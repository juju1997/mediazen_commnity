	...
	<div class="container">
		...
		<div class="card card-container login-card">
				...
				<form class="form-signin">
						...
						<input name="name" id="name" type="text" class="form-control" placeholder="이름을 입력하세요" required autofocus>
						<input name="findCode" id="findCode" type="password" class="form-control" placeholder="고유번호를 입력하세요" required>
	...
	<script>
		$(document).ready(function(){
			...
			$("#find").on("click",function(){
				...
				if((name==null || name=="") || (findCode==null || findCode=="")){
					if(name==null || name==""){
					}
					else if(findCode==null || findCode==""){
					}
				}else{
					$("form").attr("method","POST").attr("action","/user/findIDPost.do").submit();
				}
			});
